...
class gravy:
    ...
    async def inference(
        ...
        **kwargs,
        ...
        """
        Run inference on the gravy agent
    ...
    async def convert_to_model(
        ...
        **kwargs,
        ...
        """
        Converts a string to a Pydantic model using an gravy agent.
        ...
        **kwargs: Additional arguments to pass to the gravy agent as prompt arguments.
        """
