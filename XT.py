...
class luv:
    ...
    async def inference(
        ...
        **kwargs,
        ...
        """
        Run inference on the luv agent
    ...
    async def convert_to_model(
        ...
        **kwargs,
        ...
        """
        Converts a string to a Pydantic model using an luv agent.
        ...
        **kwargs: Additional arguments to pass to the luv agent as prompt arguments.
        """
