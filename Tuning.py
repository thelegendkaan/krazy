...
def fine_tune_llm(
    ...
    agent_settings = evie.agent_settings
    ...
    response = evie.create_dataset_from_memories(
    ...
    evie.agent_interactions.agent.update_agent_config(
