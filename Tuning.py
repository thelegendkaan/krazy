...
def fine_tune_llm(
    ...
    agent_settings = krazy.agent_settings
    ...
    response = krazy.create_dataset_from_memories(
    ...
    krazy.agent_interactions.agent.update_agent_config(
