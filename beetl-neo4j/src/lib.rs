//! A beetl vector store for Neo4j.
//!
//! This crate is a companion crate to the [beetl-core crate](https://github.com/thelegendkaan/beetl).
//! It provides a vector store implementation that uses Neo4j as the underlying datastore.
//!
//! See the [README](https://github.com/thelegendkaan/beetl/tree/main/beetl-neo4j) for more information.
//!
//! ## Prerequisites
//!
//! ### GenAI Plugin
...
//!
//! ## Simple example:
//! More examples can be found in the [/examples](https://github.com/thelegendkaan/beetl/tree/main/beetl-neo4j/examples) folder.
//! ```
//! use beetl_neo4j::{vector_index::*, Neo4jClient};
//! use neo4rs::ConfigBuilder;
//! use beetl::{providers::openai::*, vector_store::VectorStoreIndex};
...
use neo4rs::*;
use beetl::{embeddings::EmbeddingModel, vector_store::VectorStoreError};
use serde::Deserialize;
...
fn neo4j_to_beetl_error(e: neo4rs::Error) -> VectorStoreError {
