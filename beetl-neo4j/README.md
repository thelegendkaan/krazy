...
You can also run `cargo add beetl-neo4j beetl-core` to add the most recent versions of the dependencies to your project.
...
- Add support for creating the vector index through beetl.
