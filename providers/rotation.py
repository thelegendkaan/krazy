...
class RotationProvider:
    """
    The gravy provider rotates between available providers to handle requested based on token limits.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.agent_name = kwargs.get("agent_name", "gravy")
    ...
    async def inference(
        ...
        excluded_providers = {"gravy", "rotation", "gpt4free", "default"}
