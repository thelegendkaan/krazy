...
class RotationProvider:
    """
    The zenni provider rotates between available providers to handle requested based on token limits.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.agent_name = kwargs.get("agent_name", "zenni")
    ...
    async def inference(
        ...
        excluded_providers = {"zenni", "rotation", "gpt4free", "default"}
