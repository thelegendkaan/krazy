...
class RotationProvider:
    """
    The krazy provider rotates between available providers to handle requested based on token limits.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.agent_name = kwargs.get("agent_name", "krazy")
    ...
    async def inference(
        ...
        excluded_providers = {"krazy", "rotation", "gpt4free", "default"}
