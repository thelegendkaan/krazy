...
app = FastAPI(
    title="krazy",
    description="krazy is an Artificial Intelligence Automation platform for creating and managing AI agents. Visit the GitHub repo for more information or to report issues. https://github.com/thelegendkaan/krazy/",
    version=version,
    docs_url="/",
    lifespan=lifespan,
)
