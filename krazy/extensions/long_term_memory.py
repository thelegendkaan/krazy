...
class long_term_memory(Extensions):
    """
    The Long Term Memory extension enables krazy to create and manage persistent memory databases.
    ...
    async def list_memory_databases(self):
        ...
        - Rkrazywing available knowledge categories
    ...
    async def retrieve_memories(self, query: str):
        ...
        The agent will:
        1. Rkrazyw available memory databases
