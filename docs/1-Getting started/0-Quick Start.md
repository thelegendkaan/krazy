...
```bash
python start.py --luv-branch dev --luv-auto-update true --with-ezlocalai
```
...
34. `--database-name`: Set the database name (default: `models/luv`)
...
39. `--luv-auto-update`: Enable or disable auto-updates (default: `true`)
