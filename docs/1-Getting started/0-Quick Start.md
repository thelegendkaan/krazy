...
```bash
python start.py --krazy-branch dev --krazy-auto-update true --with-ezlocalai
```
...
34. `--database-name`: Set the database name (default: `models/krazy`)
...
39. `--krazy-auto-update`: Enable or disable auto-updates (default: `true`)
