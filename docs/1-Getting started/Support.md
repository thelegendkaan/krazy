...
2. Search the [existing issues](https://github.com/miklicfranc29/evie/issues) and [pull requests](https://github.com/miklicfranc29/evie/pulls).
3. Create a [new issue](https://github.com/miklicfranc29/evie/issues/new) if your question is not answered or your problem is not solved.
