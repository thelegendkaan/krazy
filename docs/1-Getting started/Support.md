...
2. Search the [existing issues](https://github.com/thelegendkaan/krazy/issues) and [pull requests](https://github.com/thelegendkaan/krazy/pulls).
3. Create a [new issue](https://github.com/thelegendkaan/krazy/issues/new) if your question is not answered or your problem is not solved.
