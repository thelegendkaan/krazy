...
async fn main() -> Result<()> {
    ...
    // Load PDFs using beetl's built-in PDF loader
    let documents_dir = std::env::current_dir()?.join("beetl-core/examples/documents");
    ...
    beetl::cli_chatbot::cli_chatbot(rag_agent).await?;
