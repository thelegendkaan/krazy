//! Moonshot API client and beetl integration
//!
//! # Example
//! ```
//! use beetl::providers::moonshot;
//!
...
impl Client {
    ...
    /// # Example
    /// ```
    /// use beetl::providers::moonshot::{Client, self};
    ///
...
impl completion::CompletionModel for CompletionModel {
    ...
    async fn completion(
        ...
        if response.status().is_success() {
            ...
            tracing::debug!(target: "beetl", "MoonShot completion error: {}", t);
