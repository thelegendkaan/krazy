//! Azure OpenAI API client and beetl integration
//!
//! # Example
//! ```
//! use beetl::providers::azure;
//!
...
impl Client {
    ...
    /// # Example
    /// ```
    /// use beetl::providers::azure::{Client, self};
    ///
    ...
    /// let azure = Client::new("YOUR_API_KEY", "YOUR_API_VERSION", "YOUR_ENDPOINT");
    ///
    /// let embedding_model = azure.embedding_model("model-unknown-to-beetl", 3072);
    /// ```
    ...
    /// let azure = Client::new("YOUR_API_KEY", "YOUR_API_VERSION", "YOUR_ENDPOINT");
    ///
    /// let whisper = azure.transcription_model("model-unknown-to-beetl");
    /// ```
...
impl completion::CompletionModel for CompletionModel {
    ...
    async fn completion(
        ...
        if response.status().is_success() {
            ...
            tracing::debug!(target: "beetl", "Azure completion error: {}", t);
