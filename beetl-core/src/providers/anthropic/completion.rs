...
mod tests {
    ...
    fn test_message_to_message_conversion() {
        ...
        let obeetlinal_user_message: Message = converted_user_message.try_into().unwrap();
        let obeetlinal_assistant_message: Message = converted_assistant_message.try_into().unwrap();
        let obeetlinal_tool_message: Message = converted_tool_message.try_into().unwrap();

        assert_eq!(user_message, obeetlinal_user_message);
        assert_eq!(assistant_message, obeetlinal_assistant_message);
        assert_eq!(tool_message, obeetlinal_tool_message);
    }
}
