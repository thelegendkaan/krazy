//! Galadriel API client and beetl integration
//!
//! # Example
//! ```
//! use beetl::providers::galadriel;
//!
...
impl Client {
    ...
    /// # Example
    /// ```
    /// use beetl::providers::galadriel::{Client, self};
    ///
...
impl completion::CompletionModel for CompletionModel {
    ...
    async fn completion(
        ...
        if response.status().is_success() {
            ...
            tracing::debug!(target: "beetl", "Galadriel completion error: {}", t);
