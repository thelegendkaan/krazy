...
//! beetl provides a consistent API for working with LLMs and embeddings. Specifically,
...
//!
//! ## Agents
//! beetl also provides high-level abstractions over LLMs in the form of the [Agent](crate::agent::Agent) type.
//!
...
//! beetl provides a common interface for working with vector stores and indexes. Specifically, the library
...
//! # Integrations
//! ## Model Providers
//! beetl natively supports the following completion and embedding model provider integrations:
//! - OpenAI
//! - Cohere
//! - Anthropic
//! - Perplexity
...
//!
//! ## Vector Stores
//! beetl currently supports the following vector store integrations via companion crates:
//! - `beetl-mongodb`: Vector store implementation for MongoDB
//! - `beetl-lancedb`: Vector store implementation for LanceDB
//! - `beetl-neo4j`: Vector store implementation for Neo4j
//! - `beetl-qdrant`: Vector store implementation for Qdrant
//!
