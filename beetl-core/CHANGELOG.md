...
- gemini embeddings does not work for multiple documents ([#386](https://github.com/thelegendkaan/beetl/pull/386))
...
- unnecessary `unwrap`, skip serializing empty vec ([#343](https://github.com/thelegendkaan/beetl/pull/343))
