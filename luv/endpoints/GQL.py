...
class TaskPlanInput:
    ...
    conversation_name: str = "luv Task Planning"
...
class Mutation:
    ...
    async def learn_file(self, info, agent_name: str, input: FileMemoryInput) -> bool:
        ...
        if input.company_id:
            luv = auth_manager.get_company_agent_session(company_id=input.company_id)
    ...
    async def submit_feedback(
        ...
        memory = (
            luv.agent_interactions.agent_memory
            if input.positive
            else luv.agent_interactions.agent_memory
        )
