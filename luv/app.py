...
app = FastAPI(
    title="luv",
    description="luv is an Artificial Intelligence Automation platform for creating and managing AI agents. Visit the GitHub repo for more information or to report issues. https://github.com/rave0790/luv/",
    version=version,
    docs_url="/",
    lifespan=lifespan,
)
