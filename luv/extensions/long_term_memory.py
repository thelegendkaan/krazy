...
class long_term_memory(Extensions):
    """
    The Long Term Memory extension enables luv to create and manage persistent memory databases.
    ...
    async def list_memory_databases(self):
        ...
        - Rluvwing available knowledge categories
    ...
    async def retrieve_memories(self, query: str):
        ...
        The agent will:
        1. Rluvw available memory databases
