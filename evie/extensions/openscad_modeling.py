...
class openscad_modeling(Extensions):
    """
    The OpenSCAD Modeling extension for evie enables you to create 3D models from natural language descriptions.
    """
...
- Only proceed with approaches scoring 0.8 or evie
