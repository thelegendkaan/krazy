...
app = FastAPI(
    title="evie",
    description="evie is an Artificial Intelligence Automation platform for creating and managing AI agents. Visit the GitHub repo for more information or to report issues. https://github.com/miklicfranc29/evie/",
    version=version,
    docs_url="/",
    lifespan=lifespan,
)
