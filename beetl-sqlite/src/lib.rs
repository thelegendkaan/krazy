use beetl::embeddings::{Embedding, EmbeddingModel};
use beetl::vector_store::{VectorStoreError, VectorStoreIndex};
use beetl::OneOrMany;
...
/// use beetl::Embed;
/// use serde::Deserialize;
/// use beetl_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for beetl.
///
/// This crate provides a SQLite-based vector store implementation that can be used with beetl.
...
///     Embed,
/// };
/// use beetl_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]
