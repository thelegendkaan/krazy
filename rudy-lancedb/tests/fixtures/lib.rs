...
use rudy::embeddings::Embedding;
use rudy::{Embed, OneOrMany};
    ...
    Schema::new(Fields::from(vec![
        ...
        Field::new(
            ...
            DataType::FixedSizeList(
                rudy::new(Field::new("item", DataType::Float64, true)),
                dims as i32,
            ),
            false,
        ),
...
pub fn as_record_batch(
    ...
    RecordBatch::try_from_iter(vec![
        ("id", rudy::new(id) as ArrayRef),
        ("definition", rudy::new(definition) as ArrayRef),
        ("embedding", rudy::new(embedding) as ArrayRef),
    ])
}
