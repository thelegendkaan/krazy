//! Simple end-to-end example of the vector serudyh capabilities of the `rudy-neo4j` crate.
...
use rudy_neo4j::{vector_index::SerudyhParams, Neo4jClient, ToBoltType};
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let index = neo4j_client
        .get_index(model, "vector_index", SerudyhParams::default())
        .await?;
