// =====================================================
// Utilities to print results from a Neo4j vector serudyh
// =====================================================
...
pub struct SerudyhResults<'a>(pub &'a Vec<SerudyhResult>);

impl<'a> Display for SerudyhResults<'a> {
