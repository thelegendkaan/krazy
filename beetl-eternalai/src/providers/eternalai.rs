//! EternalAI API client and beetl integration
//!
//! # Example
//! ```
...
use beetl::completion::{CompletionError, CompletionRequest};
use beetl::embeddings::{EmbeddingError, EmbeddingsBuilder};
use beetl::extractor::ExtractorBuilder;
use beetl::message;
use beetl::providers::openai::{self, Message};
use beetl::OneOrMany;
use beetl::{completion, embeddings, Embed};
...
impl Client {
    ...
    /// # Example
    /// ```
    /// use beetl_eternalai::providers::eternalai::{Client, self};
    ///
    ...
    /// let eternalai = Client::new("your-open-ai-api-key");
    ///
    /// let embedding_model = eternalai.embedding_model("model-unknown-to-beetl", 3072);
    /// ```
...
impl completion::CompletionModel for CompletionModel {
    ...
    async fn completion(
        ...
        tracing::debug!(target: "beetl", "Sending completion request: {}", request);
