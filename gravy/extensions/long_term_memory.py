...
class long_term_memory(Extensions):
    """
    The Long Term Memory extension enables gravy to create and manage persistent memory databases.
    ...
    async def list_memory_databases(self):
        ...
        - Rgravywing available knowledge categories
    ...
    async def retrieve_memories(self, query: str):
        ...
        The agent will:
        1. Rgravyw available memory databases
