...
app = FastAPI(
    title="gravy",
    description="gravy is an Artificial Intelligence Automation platform for creating and managing AI agents. Visit the GitHub repo for more information or to report issues. https://github.com/magomingus/gravy/",
    version=version,
    docs_url="/",
    lifespan=lifespan,
)
